 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ot=globalThis,Xt=Ot.trustedTypes,xe=Xt?Xt.createPolicy("lit-html",{createHTML:n=>n}):void 0,He="$lit$",k=`lit$${(Math.random()+"").slice(9)}$`,Ye="?"+k,yi=`<${Ye}>`,R=document,Ft=()=>R.createComment(""),Ut=n=>n===null||typeof n!="object"&&typeof n!="function",Re=Array.isArray,wi=n=>Re(n)||typeof(n==null?void 0:n[Symbol.iterator])=="function",ne=`[ 	
\f\r]`,Pt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Se=/-->/g,Te=/>/g,L=RegExp(`>|${ne}(?:([^\\s"'>=/]+)(${ne}*=${ne}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Me=/'/g,De=/"/g,je=/^(?:script|style|textarea|title)$/i,bi=n=>(t,...e)=>({_$litType$:n,strings:t,values:e}),P=bi(1),_t=Symbol.for("lit-noChange"),h=Symbol.for("lit-nothing"),Ce=new WeakMap,Y=R.createTreeWalker(R,129);function Ie(n,t){if(!Array.isArray(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return xe!==void 0?xe.createHTML(t):t}const $i=(n,t)=>{const e=n.length-1,r=[];let i,a=t===2?"<svg>":"",s=Pt;for(let l=0;l<e;l++){const o=n[l];let c,m,u=-1,f=0;for(;f<o.length&&(s.lastIndex=f,m=s.exec(o),m!==null);)f=s.lastIndex,s===Pt?m[1]==="!--"?s=Se:m[1]!==void 0?s=Te:m[2]!==void 0?(je.test(m[2])&&(i=RegExp("</"+m[2],"g")),s=L):m[3]!==void 0&&(s=L):s===L?m[0]===">"?(s=i??Pt,u=-1):m[1]===void 0?u=-2:(u=s.lastIndex-m[2].length,c=m[1],s=m[3]===void 0?L:m[3]==='"'?De:Me):s===De||s===Me?s=L:s===Se||s===Te?s=Pt:(s=L,i=void 0);const p=s===L&&n[l+1].startsWith("/>")?" ":"";a+=s===Pt?o+yi:u>=0?(r.push(c),o.slice(0,u)+He+o.slice(u)+k+p):o+k+(u===-2?l:p)}return[Ie(n,a+(n[e]||"<?>")+(t===2?"</svg>":"")),r]};class kt{constructor({strings:t,_$litType$:e},r){let i;this.parts=[];let a=0,s=0;const l=t.length-1,o=this.parts,[c,m]=$i(t,e);if(this.el=kt.createElement(c,r),Y.currentNode=this.el.content,e===2){const u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(i=Y.nextNode())!==null&&o.length<l;){if(i.nodeType===1){if(i.hasAttributes())for(const u of i.getAttributeNames())if(u.endsWith(He)){const f=m[s++],p=i.getAttribute(u).split(k),x=/([.?@])?(.*)/.exec(f);o.push({type:1,index:a,name:x[2],strings:p,ctor:x[1]==="."?xi:x[1]==="?"?Si:x[1]==="@"?Ti:Vt}),i.removeAttribute(u)}else u.startsWith(k)&&(o.push({type:6,index:a}),i.removeAttribute(u));if(je.test(i.tagName)){const u=i.textContent.split(k),f=u.length-1;if(f>0){i.textContent=Xt?Xt.emptyScript:"";for(let p=0;p<f;p++)i.append(u[p],Ft()),Y.nextNode(),o.push({type:2,index:++a});i.append(u[f],Ft())}}}else if(i.nodeType===8)if(i.data===Ye)o.push({type:2,index:a});else{let u=-1;for(;(u=i.data.indexOf(k,u+1))!==-1;)o.push({type:7,index:a}),u+=k.length-1}a++}}static createElement(t,e){const r=R.createElement("template");return r.innerHTML=t,r}}function xt(n,t,e=n,r){var s,l;if(t===_t)return t;let i=r!==void 0?(s=e._$Co)==null?void 0:s[r]:e._$Cl;const a=Ut(t)?void 0:t._$litDirective$;return(i==null?void 0:i.constructor)!==a&&((l=i==null?void 0:i._$AO)==null||l.call(i,!1),a===void 0?i=void 0:(i=new a(n),i._$AT(n,e,r)),r!==void 0?(e._$Co??(e._$Co=[]))[r]=i:e._$Cl=i),i!==void 0&&(t=xt(n,i._$AS(n,t.values),i,r)),t}class _i{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:r}=this._$AD,i=((t==null?void 0:t.creationScope)??R).importNode(e,!0);Y.currentNode=i;let a=Y.nextNode(),s=0,l=0,o=r[0];for(;o!==void 0;){if(s===o.index){let c;o.type===2?c=new Wt(a,a.nextSibling,this,t):o.type===1?c=new o.ctor(a,o.name,o.strings,this,t):o.type===6&&(c=new Mi(a,this,t)),this._$AV.push(c),o=r[++l]}s!==(o==null?void 0:o.index)&&(a=Y.nextNode(),s++)}return Y.currentNode=R,i}p(t){let e=0;for(const r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,e),e+=r.strings.length-2):r._$AI(t[e])),e++}}class Wt{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,e,r,i){this.type=2,this._$AH=h,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=r,this.options=i,this._$Cv=(i==null?void 0:i.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=xt(this,t,e),Ut(t)?t===h||t==null||t===""?(this._$AH!==h&&this._$AR(),this._$AH=h):t!==this._$AH&&t!==_t&&this._(t):t._$litType$!==void 0?this.g(t):t.nodeType!==void 0?this.$(t):wi(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==h&&Ut(this._$AH)?this._$AA.nextSibling.data=t:this.$(R.createTextNode(t)),this._$AH=t}g(t){var a;const{values:e,_$litType$:r}=t,i=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=kt.createElement(Ie(r.h,r.h[0]),this.options)),r);if(((a=this._$AH)==null?void 0:a._$AD)===i)this._$AH.p(e);else{const s=new _i(i,this),l=s.u(this.options);s.p(e),this.$(l),this._$AH=s}}_$AC(t){let e=Ce.get(t.strings);return e===void 0&&Ce.set(t.strings,e=new kt(t)),e}T(t){Re(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let r,i=0;for(const a of t)i===e.length?e.push(r=new Wt(this.k(Ft()),this.k(Ft()),this,this.options)):r=e[i],r._$AI(a),i++;i<e.length&&(this._$AR(r&&r._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){var r;for((r=this._$AP)==null?void 0:r.call(this,!1,!0,e);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i}}setConnected(t){var e;this._$AM===void 0&&(this._$Cv=t,(e=this._$AP)==null||e.call(this,t))}}class Vt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,r,i,a){this.type=1,this._$AH=h,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=a,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=h}_$AI(t,e=this,r,i){const a=this.strings;let s=!1;if(a===void 0)t=xt(this,t,e,0),s=!Ut(t)||t!==this._$AH&&t!==_t,s&&(this._$AH=t);else{const l=t;let o,c;for(t=a[0],o=0;o<a.length-1;o++)c=xt(this,l[r+o],e,o),c===_t&&(c=this._$AH[o]),s||(s=!Ut(c)||c!==this._$AH[o]),c===h?t=h:t!==h&&(t+=(c??"")+a[o+1]),this._$AH[o]=c}s&&!i&&this.O(t)}O(t){t===h?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class xi extends Vt{constructor(){super(...arguments),this.type=3}O(t){this.element[this.name]=t===h?void 0:t}}class Si extends Vt{constructor(){super(...arguments),this.type=4}O(t){this.element.toggleAttribute(this.name,!!t&&t!==h)}}class Ti extends Vt{constructor(t,e,r,i,a){super(t,e,r,i,a),this.type=5}_$AI(t,e=this){if((t=xt(this,t,e,0)??h)===_t)return;const r=this._$AH,i=t===h&&r!==h||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,a=t!==h&&(r===h||i);i&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e;typeof this._$AH=="function"?this._$AH.call(((e=this.options)==null?void 0:e.host)??this.element,t):this._$AH.handleEvent(t)}}class Mi{constructor(t,e,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){xt(this,t)}}const ae=Ot.litHtmlPolyfillSupport;ae==null||ae(kt,Wt),(Ot.litHtmlVersions??(Ot.litHtmlVersions=[])).push("3.1.0");const Di=(n,t,e)=>{const r=(e==null?void 0:e.renderBefore)??t;let i=r._$litPart$;if(i===void 0){const a=(e==null?void 0:e.renderBefore)??null;r._$litPart$=i=new Wt(t.insertBefore(Ft(),a),a,void 0,e??{})}return i._$AI(n),i};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var Oi=Object.defineProperty,Ei=Object.getOwnPropertyDescriptor,Yt=(n,t,e,r)=>{for(var i=r>1?void 0:r?Ei(t,e):t,a=n.length-1,s;a>=0;a--)(s=n[a])&&(i=(r?s(t,e,i):s(i))||i);return r&&i&&Oi(t,e,i),i},G,V,J,Ee;let j=(Ee=class extends E{constructor(){super(...arguments);y(this,G,void 0);y(this,V,void 0);y(this,J,void 0);d(this,G,""),d(this,V,void 0),d(this,J,localStorage.isMetric!=="false")}get locationData(){return v(this,G)}set locationData(t){d(this,G,t)}get prevLocationData(){return v(this,V)}set prevLocationData(t){d(this,V,t)}get isMetricActive(){return v(this,J)}set isMetricActive(t){d(this,J,t)}render(){return P`
  ...
  `;Yt([b({type:String})],j.prototype,"locationData",1);Yt([b({type:String})],j.prototype,"prevLocationData",1);Yt([b({type:Boolean})],j.prototype,"isMetricActive",1);Yt([Ai("input")],j.prototype,"_input",2);j=Yt([Lt("lit-controls")],j);var Fi=Object.defineProperty,Ui=Object.getOwnPropertyDescriptor,ki=(n,t,e,r)=>{for(var i=r>1?void 0:r?Ui(t,e):t,a=n.length-1,s;a>=0;a--)(s=n[a])&&(i=(r?s(t,e,i):s(i))||i);return r&&i&&Fi(t,e,i),i};let oe=class extends E{render(){return P`
      ${Ht}
  ...
  `;oe=ki([Lt("lit-current")],oe);var Ni=Object.defineProperty,Wi=Object.getOwnPropertyDescriptor,Li=(n,t,e,r)=>{for(var i=r>1?void 0:r?Wi(t,e):t,a=n.length-1,s;a>=0;a--)(s=n[a])&&(i=(r?s(t,e,i):s(i))||i);return r&&i&&Ni(t,e,i),i};let le=class extends E{render(){return P`
      ${Ht}
